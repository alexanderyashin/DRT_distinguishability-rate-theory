...
\item \textbf{Self-consistent scaling constructions (Theorems).}
For Poisson-limited localization of normal diffusion, a self-consistency argument
yields the cubic-root scaling
$\delta t_{\min} \propto \Flux^{-1/3}$.
For anomalous transport with $\mathrm{MSD}\sim t^\alpha$, this generalizes to
